...
export function NewPropertyForm({ onBehalfOfOwnerId }: { onBehalfOfOwnerId?: string } = {}) {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const url = onBehalfOfOwnerId
        ? `/api/backend/properties/on-behalf/${onBehalfOfOwnerId}`
      ...
      router.push(
        onBehalfOfOwnerId
          ? `/admin/owners/${onBehalfOfOwnerId}/properties/${data.id}`
          : `/owner/properties/${data.id}`,
      );
      router.refresh();
    } finally {
      setSubmitting(false);
